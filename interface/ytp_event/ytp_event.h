 ...
 */
#ifndef WORKSPACE_MARKET_INTERFACE_YTPEVENT_YTPEVENT_H_
#define WORKSPACE_MARKET_INTERFACE_YTPEVENT_YTPEVENT_H_
...
#endif /* WORKSPACE_MARKET_INTERFACE_BTPEVENT_YTPEVENT_H_ */
