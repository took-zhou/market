 ...
 */
#ifndef WORKSPACE_MARKET_INTERFACE_GTPEVENT_GTPEVENT_H_
#define WORKSPACE_MARKET_INTERFACE_GTPEVENT_GTPEVENT_H_
...
#endif /* WORKSPACE_MARKET_INTERFACE_BTPEVENT_GTPEVENT_H_ */
