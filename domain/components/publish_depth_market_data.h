...
struct PublishData : public MarketData {
 public:
  ...
  // mtp深度行情发送
  void DirectForwardDataToStrategy(MtpMarketDataStruct *p_d);
  void OnceFromDataflow(MtpMarketDataStruct *p_d);

  // ytp深度行情发送
  void DirectForwardDataToStrategy(YtpMarketDataStruct *p_d);
  void OnceFromDataflow(YtpMarketDataStruct *p_d);
